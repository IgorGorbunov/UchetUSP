...
{
    public class LayoutAss : IDisposable
    {
        ...
        public LayoutAss(System.Windows.Forms.Panel Panel, System.Windows.Forms.ToolStripStatusLabel ToolStripStatusLabel1)
        {
            ParentPanel = Panel;
        ...
        /// <summary>
        /// Метод создает элементы на панели
        /// </summary>
        ...
        {
            //Thread T = new Thread(new ThreadStart(LaunchPreLoader.start));
            //T.Start();
            DataTable DT = _ASSEMBLIES.getAssemblies(fromDate, toDate);

            DT.Columns[0].ColumnName = "Идентификатор сборки";
            DT.Columns[1].ColumnName = "Обозначение сборки";
            //DT.Columns[2].ColumnName = "Жетон";
            //DT.Columns[3].ColumnName = "Обозначение обрабатываемой детали";
            //DT.Columns[4].ColumnName = "Наименование технологической операции";
            //DT.Columns[5].ColumnName = "Количество элементов";
            //DT.Columns[6].ColumnName = "Дата оформления заказа на сборку";

            DT.Columns[2].ColumnName = "Количество элементов";
            DT.Columns[3].ColumnName = "Количество прихватов и планок";
            DT.Columns[4].ColumnName = "Количество болтов с гайками";
            DT.Columns[5].ColumnName = "Количество специальных элементов";
            DT.Columns[6].ColumnName = "Сложность сборки";
            ...
            dataGridView1.Columns[4].Width = 84;
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if ((cell != ""))
            {
                using (fAssemblyInfo Info = new fAssemblyInfo(Int32.Parse(cell)))
                {
                    Info.ShowDialog();
                }
            }
